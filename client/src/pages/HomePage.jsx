...
const fallbackImg = img1;
const heroSlides = [
  {
    image: img1,
    mobileImage: img1,
    title: "AutoLux",
    tagline: `Welcome back to AutoLux!`,
    button: "Explore Now",
    link: "/catalogue",
    colorScheme: "dark",
  },
...
const testimonials = [
  {
    image: fallbackImg,
    text: "“AutoLux made my car look and feel brand new. Highly recommended!”",
    name: "— Alex G.",
    stars: 5,
  },
  {
    image: fallbackImg,
    text: "“Fast delivery and amazing quality. I'll shop here again!”",
    name: "— Priya S.",
    stars: 5,
  },
  {
    image: fallbackImg,
    text: "The quality is no joke! I highly recommend the products here.”",
    name: "— Mbadwe T.",
    stars: 4,
  },
];
...
const HomePage = () => {
  ...
  const handleReviewInfo = () => {
    toast.info('This button lets you share your experience, rate our website, and leave feedback for the admin. Click to go to the review page.', {
      position: 'top-center',
      autoClose: 3500,
